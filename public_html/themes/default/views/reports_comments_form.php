...
<div class="well">
	...
	<h5>Comment with Email Address</h5>
	<?php
	if ($form_error)
	{
		?>
	...
	?>
	<div class="report_row">
		<input name="submit" type="submit" value="<?php echo Kohana::lang('ui_main.reports_btn_submit'); ?> <?php echo Kohana::lang('ui_main.comment'); ?>" class="btn btn-warning" />
	</div>
