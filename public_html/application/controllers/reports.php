...
class Reports_Controller extends Main_Controller {
	...
	public function view($id = FALSE)
	{
		...
		if ($id > 0 AND Incident_Model::is_valid_incident($id,FALSE))
		{
			...
			$this->template->header->incident_title = $incident_title;
			$this->template->header->incident_location = $incident->location->location_name;
			$this->template->header->incident_description = $incident_description;
